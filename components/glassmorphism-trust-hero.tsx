...
import { ArrowRight, Play, Target, Crown, Star } from "lucide-react";
...
export default function HeroSection() {
  return (
    <div className="relative w-full h-screen bg-zinc-950 text-white overflow-hidden font-sans">
      {/* 
        SCOPED ANIMATIONS 
      */}
      <style>{`
      ...
      <div className="relative z-10 mx-auto max-w-7xl h-full px-4 py-12 sm:px-6 lg:px-8 flex flex-col justify-center">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8">
            ...
            {/* Description */}
            <p className="animate-fade-in delay-300 max-w-xl text-base text-zinc-400 leading-relaxed">
